...
/**
 * 积分交易记录实体类 对应数据库表：point_transactions
 *
...
@Table(name = "point_transactions",
    indexes = {@Index(name = "idx_pt_user_id", columnList = "user_id"),
        @Index(name = "idx_pt_type", columnList = "type"),
        @Index(name = "idx_pt_status", columnList = "status"),
        @Index(name = "idx_pt_created_time", columnList = "created_time"),
        @Index(name = "idx_pt_reference", columnList = "reference_type, reference_id")})
public class PointTransaction extends BaseEntity {
   ...
   */
  public enum Type {
    RECHARGE(1, "充值"), CONSUME(2, "消费"), REWARD(3, "奖励"), REFUND(4, "退款"), WITHDRAW(5, "提现");
   ...
   */
  public enum Status {
    FAILED(0, "失败"), SUCCESS(1, "成功"), PROCESSING(2, "处理中");
  ...
  public boolean isIncome() {
    return Type.RECHARGE.getCode().equals(this.type) || Type.REWARD.getCode().equals(this.type)
  ...
  public boolean isExpense() {
    return Type.CONSUME.getCode().equals(this.type) || Type.WITHDRAW.getCode().equals(this.type);
  }
