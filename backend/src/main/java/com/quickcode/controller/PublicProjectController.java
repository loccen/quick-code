...
public class PublicProjectController extends BaseController {
    ...
    private List<Map<String, Object>> createMockProjects() {
        ...
        projects.add(Map.of(
                "id", 1L,
                "title", "Vue3 + TypeScript 管理后台",
                "description", "基于Vue3、TypeScript、Element Plus的现代化管理后台模板",
                "category", "web",
                "price", 299,
                "thumbnail", "/images/projects/vue-admin.jpg",
                "author", "开发者A",
                "rating", 4.8,
                "downloads", 1250,
                "tags", List.of("Vue3", "TypeScript", "Element Plus"),
                "createdAt", "2024-01-15"
        ));
        
        projects.add(Map.of(
                "id", 2L,
                "title", "React Native 电商App",
                "description", "功能完整的电商移动应用，支持iOS和Android",
                "category", "mobile",
                "price", 599,
                "thumbnail", "/images/projects/rn-ecommerce.jpg",
                "author", "开发者B",
                "rating", 4.6,
                "downloads", 890,
                "tags", List.of("React Native", "电商", "移动端"),
        ...
        projects.add(Map.of(
                ...
                "description", "企业级微服务架构解决方案，包含网关、配置中心等",
                "category", "web",
                "price", 899,
                "thumbnail", "/images/projects/springboot-microservice.jpg",
                "author", "开发者C",
                "rating", 4.9,
                "downloads", 2100,
        ...
        for (int i = 4; i <= 20; i++) {
            projects.add(Map.of(
                    "id", (long) i,
                    "title", "项目模板 " + i,
                    "description", "这是第 " + i + " 个项目模板的描述",
                    "category", i % 2 == 0 ? "web" : "mobile",
                    "price", 100 + i * 50,
                    "thumbnail", "/images/projects/default-" + i + ".jpg",
                    "author", "开发者" + (char)('A' + i % 5),
                    "rating", 4.0 + (i % 10) * 0.1,
                    "downloads", 100 + i * 50,
                    "tags", List.of("标签1", "标签2"),
                    "createdAt", "2024-01-" + String.format("%02d", i)
            ));
        }
